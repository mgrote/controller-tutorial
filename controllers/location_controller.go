...
//+kubebuilder:rbac:groups=personal-iot.mgrote,resources=locations,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=personal-iot.mgrote,resources=locations/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=personal-iot.mgrote,resources=locations/finalizers,verbs=update
